...
export default function ContactForm() {
  ...
  const inputClass = "w-full h-[56px] px-4 bg-[#111111] border border-[#2D2D2D] font-ibm-mono text-[13px] text-[#F5F5F0] placeholder:text-[#555] outline-none focus:border-[#A855F7] transition-colors";
